...
Axiom Ensures : valid_up_to g1 (n + 1%Z)%Z.

Axiom Ensures1 : array_eq g1 (mixfix_lblsmnrb g n Zero).

Parameter g2: array elem.

Axiom H5 : ((length g2) = (length g1)).

Axiom Ensures2 : array_eq g2 g1.

Axiom Requires3 : ((length g2) = 64%Z).
