...
Axiom valid_up_to_less :
  forall (g:array elem) (n:Numbers.BinNums.Z), valid_up_to g (n + 1%Z)%Z ->
  valid_up_to g n.

Axiom array_eq_sym :
  forall {a:Type} {a_WT:WhyType a},
  forall (g1:array a) (g2:array a), array_eq g1 g2 -> array_eq g2 g1.

Axiom equal_up_to_sym :
  forall {a:Type} {a_WT:WhyType a},
...
Axiom valid_up_to_useless_mod' :
  ...
  valid_up_to g n <-> valid_up_to (mixfix_lblsmnrb g n e) n.

Parameter g: array elem.

Parameter n: Numbers.BinNums.Z.

Axiom Requires : ((length g) = 64%Z).

Axiom H : (0%Z <= n)%Z.

Axiom H1 : (n <= 64%Z)%Z.

Axiom Requires1 : full_up_to g n.

Axiom Requires2 : valid_up_to g n.

Axiom H2 : ~ (n = 64%Z).

Axiom H3 : ((mixfix_lbrb g n) = Empty).

Parameter g1: array elem.

Axiom H4 : ((length g1) = (length g)).

Axiom H5 : array_eq g1 (mixfix_lblsmnrb g n Zero).

Axiom Requires3 : ((length g1) = 64%Z).
...
(* Why3 goal *)
Theorem solve_aux'vc : valid_up_to (mixfix_lblsmnrb g1 n Empty) n.
Proof.
  destruct Requires4.
  apply valid_up_to_useless_mod'.
  - rewrite Requires3; easy.
  - apply (valid_up_to_morphism g).
    + destruct (equal_up_to_useless_mod' g1 g Zero n n).
      * now rewrite Requires3.
      * easy.
      * apply equal_up_to_sym, H8.
        apply equal_equal_up_to, H5.
        rewrite Requires3; lia.
    + apply Requires2.
Qed.
